 ...
 * @var string $reset_link URL de restablecimiento de contraseña
...
<div style="max-width: 560px;padding: 20px;background: #3D3073;border-radius: 10px;margin: 40px auto;font-family: 'Open Sans', Helvetica, Arial, sans-serif;font-size: 15px;color: #ffffff">
    ...
    <div style="padding: 30px;line-height: 1.6">
        <h2 style="font-size: 22px;font-weight: 600;text-align: center;margin-bottom: 25px">
            <?php pll_e('Recuperación de contraseña'); ?>
        </h2>
        ...
        <p style="text-align: center;font-size: 16px;margin-bottom: 30px">
            <?php pll_e('Has solicitado restablecer tu contraseña. Haz clic en el siguiente botón para crear una nueva contraseña:'); ?>
        </p>
        <div style="text-align: center;margin-bottom: 30px">
            <a style="background-color: #f6ebf8;color: #3d3073;padding: 12px 30px;text-decoration: none;border-radius: 5px;font-weight: 600;display: inline-block" href="<?php echo esc_url($reset_link); ?>">
                <?php pll_e('Restablecer mi contraseña'); ?>
            </a>
        </div>
